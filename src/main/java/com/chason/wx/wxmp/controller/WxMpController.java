...
public class WxMpController {
    ...
    public String oauth(@RequestParam(value = "returnUrl") String returnUrl) {
        ...
        String redirectUrl = String.format("https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&redirect_uri=%s&response_type=code&scope=%s&state=%s#wechat_redirect", appId, URLEncoder.encode(url), "snsapi_userinfo", "state");
